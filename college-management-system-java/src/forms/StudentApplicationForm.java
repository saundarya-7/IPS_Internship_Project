 ...
 * @saundarya
 */
public class StudentApplicationForm extends javax.swing.JFrame {
    ...
    private Student retrieveData(String reg_no) {
        ...
        try {
            qry = "SELECT name, roll_no, application_no, registration_no, "
                    ...
                    + "quota, marks, status FROM student WHERE roll_no=" + reg_no;
    ...
    public void showItemToFields(int index, String roll_no) {
        ...
        try {
            ...
            _dob = sdf.parse(data.getDob());
            DOBChooser.setDate(_dob);
            Date _date;
    ...
    private void initComponents() {
        ...
        TitleLabel.setText(bundle.getString("STUDENT_APP_FORM")); // NOI18N
        ...
        HostelCheckBox.setForeground(new java.awt.Color(51, 0, 153));
        HostelCheckBox.setText("Hostel");

        LibraryCheckBox.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        LibraryCheckBox.setForeground(new java.awt.Color(51, 0, 153));
        ...
        PhotoChooserButton.setForeground(new java.awt.Color(51, 0, 153));
        ...
        CourseLoadingButton.setForeground(new java.awt.Color(51, 0, 153));
        ...
        BranchLoadingButton.setForeground(new java.awt.Color(51, 0, 153));
        ...
        SemLoadingButton.setForeground(new java.awt.Color(51, 0, 153));
    ...
    private void _saveStudentData() {
        if (photopath == null) {
            ...
            final String insert_sql = "INSERT INTO student(name, roll_no, application_no, registration_no, "
                    ...
                    + "qualification, university, quota, marks) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            try {
                ...
                if (i >= 1) {
                    JOptionPane.showMessageDialog(null, "Your application is submitted. Your Registration No. is [" + RegNoTextField.getText() + "].", "Success", 1);
                    clearFields();
                } else {
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        if (_checkInputFields()) {
            int choice = JOptionPane.showConfirmDialog(null, "Do You want submit application form?", "Confirm", 0, 3);
            if (choice == 0) {
                _saveStudentData();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentApplicationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
